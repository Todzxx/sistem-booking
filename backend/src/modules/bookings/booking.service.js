...
const bookingService = {
  ...
  createBooking: async (bookingData, userId) => {
    ...
    return await db.transaction(async (tx) => {
      ...
      for (const b of bookingsToNotify) {
        notificationService.emitBookingEvent('BOOKING_CREATED', b, userId);
      }
  ...
  updateStatus: async (id, status, notes) => {
    ...
    return await db.transaction(async (tx) => {
      ...
      notificationService.emitBookingEvent(eventType, updated, booking.userId);
  ...
  cancelBooking: async (id, userId, cancelAll = false) => {
    ...
    notificationService.emitBookingEvent('BOOKING_CANCELLED', cancelledBooking, userId);
