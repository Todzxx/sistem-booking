...
// Navbar mobile — muncul di layar kecil (< lg), di-hidden saat lg+
// Menampilkan logo, theme switcher, notifikasi bell, dan hamburger menu
// ============================================================
...
export const Navbar = () => {
  ...
  // Tampilan untuk user BELUM login — tombol Login, tanpa menu
  if (!token) {
    return (
