      ...
      <Card className="p-8 rounded-xl border border-default-200 bg-default-50/50">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex items-start gap-4">
            <div className="w-14 h-14 rounded-xl bg-default-100 text-primary flex items-center justify-center shrink-0">
              <HelpCircle size={28} />
            </div>
            <div>
          ...
          <div className="flex items-center gap-3 px-4 py-3 rounded-lg bg-background border border-default-200 text-sm font-bold text-default-600">
            <Mail className="text-primary" size={18} /> Contact your system
            administrator
          </div>
        </div>
      </Card>
