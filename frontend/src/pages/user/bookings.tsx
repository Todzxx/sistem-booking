    ...
    return (
      <div className="max-w-4xl mx-auto py-8 px-4">
        <div className="mb-8">
          ...
          <div className="h-5 w-72 bg-default-100 rounded-lg animate-pulse mt-2" />
        </div>
        <div className="grid gap-4">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="p-6 rounded-2xl border border-default-200 bg-default-50 animate-pulse"
            >
              <div className="flex items-start justify-between gap-4">
                <div className="space-y-3 flex-1">
                  <div className="flex items-center gap-3">
                    <div className="w-[18px] h-[18px] rounded bg-default-200" />
                    <div className="h-5 w-40 bg-default-200 rounded-lg" />
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-4 h-4 rounded bg-default-200" />
                    <div className="h-4 w-32 bg-default-200 rounded-lg" />
                    <div className="w-4 h-4 rounded bg-default-200" />
                    <div className="h-4 w-28 bg-default-200 rounded-lg" />
                  </div>
                  <div className="h-4 w-56 bg-default-100 rounded-lg" />
                </div>
